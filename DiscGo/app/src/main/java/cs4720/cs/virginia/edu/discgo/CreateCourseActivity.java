...
//        courseName = getIntent().getStringExtra(Intent.EXTRA_TEXT);
        ...
        List<ParseObject> courses = null;
        try {
            courses = query.find();
            for (int i = 0; i < courses.size(); i++) {
                courseNames.add((String) courses.get(i).get("courseName"));
            }
    ...
    class CustomListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if(!courseNames.contains(courseName)){
                ...
                Toast.makeText(CreateCourseActivity.this, "Course name already exists", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
